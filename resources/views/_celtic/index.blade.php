...
<head>
    ...
    @else
        <title>Газовые котлы Celtic - продажа котлов по всей России. Настенные газовые котлы из Южной Кореи.</title>
        <meta name="description" content="Интернет-магазин Celtic. Каталог настенных газовых котлов. Продажа запчастей для Celtic. Как купить котел. Советы по выбору.">
        <meta name="keywords" content="газовый котел, купить котел селтик, продажа котлов, настенные котлы, запчасти к котлам селтик, котлы Celtic">
    @endif
